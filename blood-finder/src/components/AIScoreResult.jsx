          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            {matchedDonorsData.map((donor, index) => (
              ...
              >
                ...
                {/* Top accent */}
                <div className="h-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-red-500" />
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      ">
                        ...
                        <div className="
                          ...
                          p-3
                        ">
                          <p className="text-[11px] sm:text-xs text-slate-500 uppercase tracking-wide">
                            Blood Group
                          </p>
              ...
              ">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-200 text-xs font-bold tracking-wider">
                      DONOR REQUEST
                    </p>
            ...
            <div className="p-5 sm:p-6">
              ...
              ">
                ...
                ">
                  ...
                  <p className="text-slate-900 font-bold mt-1 break-all">
                    {selectedDonor.id}
                  </p>
                </div>
